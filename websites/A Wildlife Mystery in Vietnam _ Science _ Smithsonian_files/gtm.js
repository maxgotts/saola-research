...
"resource": {
  ...
  "rules":[
    ...
    [["if",1,100],["add",79,88]],
    [["if",1],["add",90,91,92,93,94,98,99,100,101,102,103,104,105,106]],
    [["if",1,101],["add",95]],
    [["if",1,102],["add",96,97]],
    [["if",1,99],["add",107]],
    [["if",1,103],["add",108]],
    ...
    [["if",1,106],["add",111]],
    [["if",6,107],["add",112]],
    [["if",1,29],["add",113],["block",22,23,29]],
    [["if",33,39],["add",114]],
    [["if",0,33],["block",26,27]],
    [["if",33,45],["block",109]]]
},
...
n(String,d.vtp_eventLabel),n(qa,d.vtp_eventValue),!!d.vtp_nonInteraction);}else if("TRACK_TRANSACTION"==d.vtp_trackType){var C=function(J){return oh("transaction"+J,1)},D=C("Id");e("_addTrans",D,C("Affiliation"),C("Total"),C("Tax"),C("Shipping"));for(var H=C("Products")||[],N=0;N<H.length;N++){var R=H[N];e("_addItem",D,R.sku,R.name,R.category,R.price,R.quantity)}e("_trackTrans");
...
d.vtp_trackType){}else if("DECORATE_LINK"==d.vtp_trackType){var Q=oh("gtm.element",1);Q&&q.push(function(){var J=L("_gat"),I=J._getTrackerByName(v.slice(0,
-1)),T=Q.href;if(T){var U=/(.*)([?&#])(?:__utma=.*__utmk=[^&]*)(?:&?)(.*)/.exec(T);U&&3<=U.length&&(T=U[1]+(U[3]?U[2]+U[3]:""));Q.href=I._getLinkerUrl(T,d.vtp_useHashDecorateLink);z(d.vtp_gtmOnSuccess)}});}else if("DECORATE_FORM"==d.vtp_trackType){}else e("_trackPageview");k("_cookiePathCopy",d.vtp_cookiePathCopy);
